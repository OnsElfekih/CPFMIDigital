...
import CombinedLayoutAdmin from "./CombinedLayoutAdmin"; // ✅ Import
import "./EvaluationFormateur.css"; // Assure-toi que ce CSS contient les styles "main-content"
...
export default function FicheFormateurEvaluation() {
  ...
  const [isSidebarOpen, setIsSidebarOpen] = useState(false); // ✅ Gestion sidebar
